    ...
    for filename in filenames:
        ...
        if filename.endswith(".json"):
            ...
            try:
                ...
                exit()
            os.rename("./intents/" + filename, "./intents/done/" + re.sub(".json","",filename) + "-added-" + re.sub(":",".",re.sub(" ", "_", time.ctime())) + ".json")
...
def delete_intents():
    ...
    for filename in filenames:
        ...
        try:
            ...
            exit()
        os.rename("./intents/" + filename, "./intents/done/" + re.sub(".json","",filename) + "-deleted-" + re.sub(":",".",re.sub(" ", "_", time.ctime())) + ".json")
def banner():
    print("""
==========================================================
