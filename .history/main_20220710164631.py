    ...
    for filename in filenames:
        ...
        if filename.endswith(".json"):
            ...
            try:
                ...
                exit()
            os.rename("./intents/" + filename, "./intents/done/" + filename)
...
def delete_intents():
    ...
    for filename in filenames:
        ...
        if get_intent(config['project_id'], intentName) is None:
            ...
            continue
        try:
            delete_intent(config['project_id'], get_intent(config['project_id'], intentName).name)
        except Exception as e:
...
if __name__ == "__main__":
    print(get_intent(config['project_id'], intentName).name)